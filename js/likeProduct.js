var wishlistTableBody = document.querySelector('#tableBody');
...
function displayprod(Data) {
    ...
    for (var i = 0; i < Data.length; i++) {
        ...
        productDe += `<tr>
            ...
            <td id=` + Data[i].id + ` onclick=removefromWishlist(this.id) class="th-delate"><a href="#">X</a></td>
    ...
    console.log(Data)
    wishlistTableBody.innerHTML = productDe;
}
