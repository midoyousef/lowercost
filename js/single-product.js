      ...
      <div class="product-big-image col-xs-12 col-sm-5 col-lg-5 col-md-5">
        ...
        <div class="flexslider flexslider-thumb">
          <ul class="previews-list slides">
            ...
            <li><a class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'http://aaaserver-001-site31.ftempurl.com` + Data.subCategory.image + `' "><img src="http://aaaserver-001-site31.ftempurl.com` + Data.brand.image + `" alt = "Thumbnail 1"/></a></li>
