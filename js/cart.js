...
if (localStorage.getItem("orders")) {
  ...
  // orders.push(x)
  // document.getElementById('cart-total').innerText = z.length;
} else {
  orders = [];
}
console.log(lang)
...
function displayDataCart2() {
  ...
  if (x) {
    ...
    if (document.getElementById("cartNo")) {
      document.getElementById("cartNo").innerHTML = `<i class="icon-basket-loaded icons"></i> <span class="cart-total" id="cart-total">` + z.length + `</span>`
    }
  }
